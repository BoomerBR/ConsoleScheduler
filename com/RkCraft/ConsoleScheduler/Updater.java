...
public class Updater {
    ...
    public ReleaseType getLatestType() {
        ...
        if (this.versionType != null) {
            for (ReleaseType tipo : ReleaseType.values()) {
                if (this.versionType.equalsIgnoreCase(tipo.name())) {
                    return tipo;
                }
            }
        }
                ...
                while (e.hasMoreElements()) {
                    ...
                    if (!entry.isDirectory()) {
                        try (BufferedInputStream bis = new BufferedInputStream(zipFile.getInputStream(entry))) {
                            ...
                            try (BufferedOutputStream bos = new BufferedOutputStream(fos, Updater.BYTE_SIZE)) {
    ...
    private boolean pluginExists(String name) {
        ...
        for (final File arquivo : plugins) {
            if (arquivo.getName().equals(name)) {
                return true;
            }
        }
        return false;
